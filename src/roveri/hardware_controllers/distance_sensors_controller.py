...
def all_sensors_strategy(
    sensor_values: tuple[int, int, int], min_distance: int, max_distance: int
) -> bool:
    """
    ...
    """
    return all(
        min_distance < sensor_value < max_distance for sensor_value in sensor_values
    )


def any_sensor_strategy(
    sensor_values: tuple[int, int, int], min_distance: int, max_distance: int
) -> bool:
    """
    This function is used to determine if the robot is about to collide with an obstacle.
...
class DistanceSensorsController(metaclass=Singleton):
    ...
    def is_about_to_collide(
        self, strategy: Callable[[tuple[int, int, int], int, int], bool]
    ) -> bool:
        pass
...
class DistanceSensorsControllerRaspberry(DistanceSensorsController):
    ...
    def is_about_to_collide(
        ...
        return strategy(sensor_data, self._min_distance, self._max_distance)
